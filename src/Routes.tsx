...
import { CompaniesRoute } from './views/companies/Routes';
...
const App = () => {
  ...
  const ProtectedRoutes: IRoute[] = [HomeRoute, JobSeekerRoute, CompaniesRoute, ApplicationsRoute, SettingsRoute, RegisterDataRoute];
